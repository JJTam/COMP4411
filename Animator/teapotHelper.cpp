/*
 This file is copied from glut-3.7 source code.
 It is used to draw a teapot.
*/
...
void APIENTRY glutSolidTeapot(GLdouble scale)
{
	teapot(14, scale, GL_FILL);
}

void APIENTRY glutWireTeapot(GLdouble scale)
{
